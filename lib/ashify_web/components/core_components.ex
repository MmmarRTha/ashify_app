defmodule AshifyWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: AshifyWeb.Gettext
  use AshifyWeb, :verified_routes
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AshifyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AshifyWeb.Gettext, "errors", msg, opts)
    end
  end
