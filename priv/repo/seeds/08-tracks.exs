...
album_names = Enum.map(Ashify.Seeder.albums(), & &1.name)
...
|> Ash.bulk_create!(Ashify.Music.Track, :create, skip_unknown_inputs: [:*], return_errors?: true, authorize?: false)
